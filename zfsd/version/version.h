...
extern int32_t version_readdir_from_dirhtab(dir_list * list,
											internal_dentry dentry,
											int32_t cookie,
											readdir_data * data,
											filldir_f filldir);
extern int32_t version_readdir_fill_dirhtab(internal_dentry dentry,
											time_t stamp, long ino,
											char *name);
...
extern int32_t version_create_file_with_attr(char *path,
											 internal_dentry dentry,
											 volume vol, string * orgpath);
...
extern int32_t version_truncate_file(internal_dentry dentry, volume vol,
									 char *path);
...
extern int32_t version_get_filename_stamp(char *name, time_t * stamp,
										  int *orgnamelen);
extern int32_t version_is_directory(string * dst, char *dir, string * name,
									time_t stamp, time_t * dirstamp,
									int orgnamelen);
extern int32_t version_build_intervals(internal_dentry dentry, volume vol);
extern int32_t version_read_old_data(internal_dentry dentry, uint64_t start,
									 uint64_t end, char *buf);
...
extern int32_t version_copy_data(int fd, int fdv, uint64_t offset,
								 uint32_t length, data_buffer * newdata);
