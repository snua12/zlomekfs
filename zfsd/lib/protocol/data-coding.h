...
/* Copyright (C) 2003, 2004 Josef Zlomek Copyright (C) 2004 Martin Zlomek
   ...
   with zlomekFS; if not, write to the Free Software Foundation, Inc., 51
...
extern bool decode_connection_speed(DC * dc, connection_speed * speed);
...
extern bool encode_reread_config_args(DC * dc,
									  const reread_config_args * args);
