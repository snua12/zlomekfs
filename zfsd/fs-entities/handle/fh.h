...
extern virtual_dir vd_lookup_name_dirstamp(virtual_dir parent, string * name,
										   time_t * dirstamp);
...
extern internal_dentry internal_dentry_create_ns(zfs_fh * local_fh,
												 zfs_fh * master_fh,
												 volume vol,
												 internal_dentry parent,
												 string * name, fattr * attr,
...
extern internal_dentry internal_dentry_link(internal_dentry orig,
											internal_dentry parent,
											string * name);
extern void internal_dentry_move(internal_dentry * from_dirp,
								 string * from_name, internal_dentry * to_dirp,
								 string * to_name, volume * volp,
