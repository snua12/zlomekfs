...
static message_handle_state_e reply_to_ping(DBusMessage * msg,
											DBusConnection * conn)
{
	DBusMessage *reply;
	...
	if (!dbus_message_iter_append_basic
		(&args, ZFSD_STATUS_INFO_DBUS_TYPE, &state))
	{
...
int dbus_release_zfsd_name(DBusConnection * connection, DBusError * err_struct)
{
	int ret_code = TRUE;
