			       ...
			       void *data)
{
  ...
  if (d->depth == 0)
  {
    ...
    /*TODO: is this correct eg spaced after node_name or node_name_with_some_suffixes*/
    if (strncmp (line + i, node_name.str, node_name.len + 1) == 0)
    {
      ...
      //TODO: if master_name is not set then use this_node, everything without warning !!!!
      if (master_name)
      {
          str.str = master_name;
