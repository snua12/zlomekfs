...
/*! \file
    \brief Logger specific errors and helper functions.

  Errors are enumerated int with predefined values.

  Use bigger number to avoid missinterpretation as system error.
  Please add string description to the error in syp_error_to_string too
...
/*! Returns user readable description of error
  @param error error occured
  @return static string description of error
*/
char * syp_error_to_string (syp_error error);

/*! Translates system error to syplog errors
  @param sys_error system error
  @return syp_error equivalent of system_error or ERR_SYSTEM when unknown
*/
