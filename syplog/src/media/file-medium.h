...
/* ! \file \brief File medium functions definitions.  */
...
/* ! Check if argument is recognized by file medium @param arg command line
...
/* ! Parse params and initialize file medium If NULL argv is given, defaults
   will be used.

   @see open_medium @see medium-api.h */
syp_error open_file_medium(struct medium_def *target, int argc,
						   const char **argv);

/* ! Close file medium and free file medium specific structures @see
...
/* ! prints file options help to fd. @see print_medium_help @see medium-api.h */
