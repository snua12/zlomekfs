...
/* ! Parse params and initialize shm segment @see open_medium @see
   medium-api.h */
syp_error open_shm_medium(struct medium_def *target, int argc,
						  const char **argv);

/* ! Close shm medium and free shm medium internals. Doesn't destroy shm
...
/* ! prints shm options help to fd. @see print_medium_help @see medium-api.h */
