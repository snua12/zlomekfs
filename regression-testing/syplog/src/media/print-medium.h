...
/*! Parse params and initialize print medium
  If NULL argv is given, defaults will be used.

  @see open_medium
  @see medium-api.h
*/
syp_error open_print_medium (struct medium_def * target, int argc, const char ** argv);

/*! Close print medium and free print medium specific structures
  @see close_medium
  @see medium-api.h
*/
...
/*! prints print options help to fd.
